...
import 'package:movil_sv/app/ui/pages/home/painter.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final _initialCameraPosition =
      const CameraPosition(target: LatLng(13.7138432,-89.2172711), zoom: 12);
  _onTap(LatLng position) async {
    ...
    final icon = await BitmapDescriptor.fromAssetImage(
        const ImageConfiguration(size: Size(30, 40)), 'assets/img/auto.png');
